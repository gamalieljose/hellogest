...
<?php 
echo '<p><a href="index.php?module=conta&section=grupos&idejercicio='.$idejercicio.'&action=new" class="btnedit">Nuevo grupo</a></p>'; 
?>
...
$cnssql= $mysqli->query("select * from ".$prefixsql."conta_grupos where idserie = '".$idejercicio."' and idempresa = '".$idempresa."'");	
while($col = mysqli_fetch_array($cnssql))
{
    ...
    echo '<td><a href="index.php?module=conta&section=grupos&idejercicio='.$idejercicio.'&action=edit&id='.$col["id"].'" class="btnedit">Editar</a></td>';
    echo '<td>'.$col["codgrupo"].'</td>';
