...
<div class="col-sm-2">
  ...
  <div class="col" align="left">
	<label><input type="checkbox" value="1" name="chknewticket" checked="" /> Crear automáticamente un ticket</label> </br>
	<input type="number" value="0" min="0" name="txtticket" class="campoencoger" />
  </div>
</div>
<div class="row">
  <div class="col-sm-2">
...
<div class="row">
  ...
  <div class="col" align="left">
	...
	while($usuarios = mysqli_fetch_array($cnsusers))
	{
		...
		if($usuarios["id"] == $_COOKIE["lnxuserid"]){$seleccionado = ' selected=""';}else{$seleccionado = '';}
...
<div class="row">
  ...
  <?php 
  $fechahoy = date("d/m/Y");
  echo '<input type="text" maxlength="10" value="'.$fechahoy.'" name="txtfecha" id="dpkfecha" required="" style="width: 100%;">'; ?>
  </div>
  <div class="col-sm-2">
...
while ($hora < 24)
{
	...
	if($horaconcero == $thorain){$seleccionado = ' selected=""';}else{$seleccionado = '';}
...
while ($minutos < 60)
{
	...
	if($horaconcero == $tminin){$seleccionado = ' selected=""';}else{$seleccionado = '';}
...
<div class="row">
    ...
    <div class="col">
        <textarea name="txtintervencion" id="txtintervencion" style="width: 100%;" required=""></textarea>
    </div>
</div>
