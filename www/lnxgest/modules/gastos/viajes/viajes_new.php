...
<a href="index.php?module=gastos&section=viajes" class="btncancel"><i class="hidephonview fa fa-window-close fa-lg"></i> Cancelar</a> 
</div>
...
while ($minutos < 60)
{
	...
	if($horaconcero == $minutoactual){$seleccionado = ' selected=""';}else{$seleccionado = '';}
...
<div class="col">
Fecha vuelta </br>
    <input type="text" value="<?php echo $fechahoy; ?>" name="dpkfechavuelta" id="dpkfechavuelta" style="width: 100px;" maxlength="10" required pattern=".{10,10}"  title="dd/mm/yyyy" />
