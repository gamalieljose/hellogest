...
$dbfechavuelta = $row["fechavuelta"];
    $xtemp = explode(" ", $dbfechavuelta);
    $xtemp2 = explode("-", $xtemp[0]);
    $lbl_fechavuelta_dft = $xtemp2[2]."/".$xtemp2[1]."/".$xtemp2[0];

    $xtemp2 = explode(":", $xtemp[1]);
    $lbl_fechavuelta_h_dft = $xtemp2[0];
    $lbl_fechavuelta_m_dft = $xtemp2[1];
...
<?php
echo "document.getElementById('dpkfechavuelta').value = '".$lbl_fechavuelta_dft."' ;";
echo "document.getElementById('tiempohh_vuelta').value = '".$lbl_fechavuelta_h_dft."'; ";
echo "document.getElementById('tiempomin_vuelta').value = '".$lbl_fechavuelta_m_dft."'; ";
?>        
}
</script>
...
<div class="col-sm-3">
    <input type="text" name="txtorigen" placeholder="Lugar de origen" value="<?php echo $db_origen; ?>" maxlength="50" style="width: 100%;" />
</div>
<div class="col-sm-3">
    <input type="text" name="txtdestino" placeholder="Lugar de destino" value="<?php echo $db_destino; ?>" maxlength="50" style="width: 100%;" />
</div>
</div>
<?php
