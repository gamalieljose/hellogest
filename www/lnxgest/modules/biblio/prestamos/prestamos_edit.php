...
$lbl_prestamo = $lblfecha." por ".$lbltercerocontacto;
...
<div class="row">
	...
	<div class="col">
    <input type="text" id="txtfecha" name="txtfecha" value="<?php echo $lblfecha; ?>" maxlength="10" required pattern=".{10,10}" title="dd/mm/yyyy" />
	</div>
</div>
<div class="row">
	<div class="col-sm-2">
...
if ($color == '1'){$color = '2'; $pintacolor = "listacolor2";} else {$color = '1'; $pintacolor = "listacolor1";}
	...
	echo '<input type="radio" name="optlibro" checked="" value="'.$dbidlibro.'" />';
	echo '</td>';
