<?php
echo '<p><a class="btnedit" href="index.php?module=core&section=modulos&action=new">Nuevo Modulo</a></p>';
?>
...
<?php
	...
	while($modulo = mysqli_fetch_array($ConsultaMySql))
	{
		...
		echo '<td><a class="btnedit" href="index.php?module=core&section=modulos&action=edit&id='.$modulo["id"].'">Editar</a></td>';
