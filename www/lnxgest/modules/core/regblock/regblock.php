...
<form name="frmspool" method="POST" action="index.php?module=core&section=regblock&action=save">
...
<?php
$ConsultaMySql= $mysqli->query("select * from ".$prefixsql."bloqueos order by fecha asc");
