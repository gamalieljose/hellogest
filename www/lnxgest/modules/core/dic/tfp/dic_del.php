<?php
$sqlbuscar= $mysqli->query("SELECT * from ".$prefixsql."dic_docseries where id = '".$_GET["id"]."'");
$row = mysqli_fetch_assoc($sqlbuscar);
$dbdocserie = $row["docserie"];
$dbvalor = $row["valor"];
?>
<div align="center">
<form id="form1" name="form1" method="post" action="index.php?module=core&section=dic&subs=tfp&action=save">
...
<tr><td>Va a eliminar esta serie: <b><?php echo $dbdocserie; ?> </b></br></br>&iquest;Est&aacute; usted seguro?</td></tr>
<tr><td align="center">
