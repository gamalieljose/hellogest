...
<div class="row">
  ...
  <div class="col" align="left">
    <?php echo '<input type="text" maxlength="50" value="" name="txtformacontacto" required="" class="campoencoger">'; ?>
  </div>
</div>
...
<div class="row">
  ...
  <div class="col" align="left">
    <?php echo '<input type="text" maxlength="50" value="" name="txtfichero" required="" class="campoencoger">'; ?>
  </div>
</div>
