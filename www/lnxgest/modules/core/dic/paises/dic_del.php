<?php
$sqlbuscar= $mysqli->query("SELECT * from ".$prefixsql."paises where id = '".$_GET["id"]."'");
$row = mysqli_fetch_assoc($sqlbuscar);
$dbpais = $row["pais"];
?>
<div align="center">
<form id="form1" name="form1" method="post" action="index.php?module=core&section=dic&subs=paises&action=save">
...
<tr><td>Va a eliminar este pais: <b><?php echo $dbpais; ?> </b></br></br>&iquest;Est&aacute; usted seguro?</td></tr>
<tr><td align="center">
