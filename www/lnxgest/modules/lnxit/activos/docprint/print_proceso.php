...
include("modules/lnxit/activos/docprint/".$ficherodocprint);



if ($flstprinter > '0'){ header( "refresh:2;url=index.php?module=lnxit&section=activos&ss=activo&action=edit&id=".$fhidactivo );}
...
echo '<div align="center">
	...
	<tr><td align="center">
	<a class="btnedit" href="index.php?module=lnxit&section=activos&ss=activo&action=edit&id='.$fhidactivo.'">Aceptar</a> ';
