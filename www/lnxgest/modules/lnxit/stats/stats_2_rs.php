...
echo '<h2>Estadisticas tickets abiertos por usuario</h2>';
...
while($columna = mysqli_fetch_array($ConsultaMySql))
{
	...
	$ssql = "SELECT * FROM ".$prefixsql."it_tickets where fcreacion >= '".$cfechainicio."' and fcreacion <= '".$cfechafin."' and idasignado = '".$columna["id"]."' and idestado > '0' ";
	$cnssql = $mysqli->query($ssql);
	$nregistros = $cnssql->num_rows;
	$sumatd = '00:00';
	$sumatc = '00:00';
	if ($nregistros > '0')
	{
		...
		echo '<tr class="maintitle"><td>Ticket</td><td>Estado</td><td>Fecha</td><td>resumen</td><td>Categoria</td><td>tiempo</td><td>Computado</td><td>Facturado</td></tr>';
		$color = '1';
